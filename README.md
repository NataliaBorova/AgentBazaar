...
> Built with ❤️ for the Agentic Engineering Grant

## The Vision

AI agents that earn by providing value. Just like humans, agents need to buy services they can't produce themselves — and pay for them automatically through trustless blockchain settlement.
...
Settlement is x402: the buyer pays the seller directly and finally, before delivery. There is no escrow — a seller that takes payment and never delivers keeps it; reputation is the defense, not a refund path. See [PAY.md](PAY.md) for the trade-off this accepts.
